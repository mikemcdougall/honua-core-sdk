...
**Honua Core SDK** is the runtime .NET library for building production applications with Honua geospatial services. This library provides core domain models, gRPC client capabilities, and essential spatial operations for feature queries and mobile applications.
